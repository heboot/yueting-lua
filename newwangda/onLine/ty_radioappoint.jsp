...
<c:set var="lua" value="/resource/mobileaudio3/radiolive/ty_radioappoint.wdml" /><%//定义本文件lua部分模板路径%>
...
<root>
	...
	<node  rect="0,0,720,1168" padding="0,0,112,0" extendstyle="1116">
        ...
        <label name="mainTitle" rect="0,0,720,77" extendstyle="1110" text="预约节目" color="#FFFFFF" v-align="center" h-align="center" font-size="42"/>
	    </node>
		 
		<node name="catalogNode" rect="0,113,688,90"   extendstyle="1111" >
	     <list name="catalogList" rect='16,0,688,90' extendstyle='1010' auto-adjust="true" line='1' col='2'>
         ...
         <list-item  rect="0,0,344,90" extendstyle="1010">
		   <button name="catalogBtn" rect="3,3,340,84"  normal="n" sel="s" disabled ="d" OnSelect="catalogBtnOnSelect" extendstyle="1010">      
			 ...
			 <node name="d" rect="0,0,340,84"  extendstyle="1010">
			   <image rect="0,0,340,84" src="file://image/appointbtnbg.png"  style="autosize"  extendstyle="1010" />
			   <label rect="0,0,340,84"  text="$(text)" v-align="center" h-align="center" color="#D2691E" extendstyle="1010"/>
			 </node>
		   </button>
        </list-item>
		   <dataset>
		   <set text="今日节目"/><set text="明日节目"/>	 
		   </dataset>
          </list>    
	    </node>
