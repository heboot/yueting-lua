...
<c:set var="lua" value="/resource/mobileaudio3/audioplay/ty_audioplay.wdml" /><%//定义本文件lua部分模板路径%>
    ...
    <node name="mainNode" rect="0,0,720,1280" extendstyle="1111" layouttype="1" OnKeyUp="mainNodeOnKeyUp">
        ...
        <node name="mianTopNode" rect="0,0,720,90"  extendstyle="1111">
		   ...
		   <button name="backBtn" normal="n" sel="s" rect="10,15,104,61" extendstyle="1111" OnSelect="backBtnOnSelect" visible="1" enable="1">
            ...
            <scrolltext name="mainTitle" step="2" scroll="true"  rect="0,0,400,77" extendstyle="8110" text="" color="#FFFFFF" v-align="center" h-align="center" font-size="42"/>
		    <button name="selectedWorksBtn" normal="n" sel="s" rect="520,15,96,59" extendstyle="1111" OnSelect="selectedWorksBtnOnSelect" visible="1" enable="1">
			...
			<label rect="0,0,0,0" extendstyle="0077" text="选集" color="#FFFFFF" v-align="center" h-align="center" font-size="35"/>
			</button>
        ...
        <node rect="0,0,0,508"  extendstyle="1871">
		  <image rect="0,0,0,0" style="minsize" src="file://image/playyue_bg.png" extendstyle="1077"/>
		  <node rect="0,0,0,150"  extendstyle="1071" font-family="TianyiDigital">
		  ...
		  <node rect="0,0,0,170"  extendstyle="1877">
			<node name="playingAnimation" rect="0,0,170,170" extendstyle="1010" visible="0" enable="0">
			 ...
			 <label name="anchor" rect="0,0,120,90" color="#f06a06" text="佚名"  font-size="35" v-align="bottom" h-align="center"  postfix=".." extendstyle="1111"/>
			 <label rect="0,0,60,90" color="#f06a06" text="主播"  font-size="25" v-align="bottom" h-align="center" extendstyle="8111"/>
			 </node>
			 </node>
		  </node>
		</node>
