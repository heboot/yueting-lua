...
<c:set var="lua" value="/resource/mobileaudio3/podcast/ty_bokecollected.wdml" /><%//定义本文件lua部分模板路径%>
...
<root>
	...
	<node  rect="0,0,720,1168" padding="0,0,112,0" extendstyle="1116">
        ...
        <label name="mainTitle" rect="0,0,720,77" extendstyle="1110" text="作品收藏" color="#FFFFFF" v-align="center" h-align="center" font-size="42"/>
	    </node>
	...
	<node name="contentItem" rect="0,0,686,160" extendstyle="1010"  visible="0" enable="0" active="0">
		...
		<image name="podcastImage"  rect="20,15,210,141" style="autosize" extendstyle="1111"/>
		<label name="podcastName" rect="250,10,400,55" v-align="center" postfix=".."  extendstyle="1111" color="#FFFFFF"  font-size="35"/>	
		<label rect="250,100,70,40" v-align="center" h-align="center" text="主播:" extendstyle="1111" color="#999999"  font-size="28"/>			
		<label name="podcastAnchor" rect="0,100,200,40" text="佚名" v-align="center"   postfix=".."  extendstyle="8111" color="#999999"  font-size="28"/>
